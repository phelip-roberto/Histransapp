...
@Component({
  selector: 'app-sales-table-loj',
  templateUrl: './sales-table-loj.component.html',
  styleUrls: ['./sales-table-loj.component.scss'],
  animations: [
...
export class SalesTableLojComponent implements OnInit {
  ...
  filterGetTransactions(formData) {
    ...
    formData.mid = this.userInfo.mid;
